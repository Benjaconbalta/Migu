      ...
      child: TextFormField(
        ...
        inputFormatters: [
          if (filterNumbers) // Solo si se debe filtrar números
            FilteringTextInputFormatter.deny(
                RegExp(r'[0-9]')), // Filtra los números
        ],
        onChanged: onChanged,
        validator: validator,
        ...
        decoration: InputDecoration(
         prefixIcon: icon? const Icon(Icons.search,size: 30,):null,
          ...
          fillColor: Colors.grey[300], // Color de fondo oscuro
...
class CustomTextInput extends StatelessWidget {
  ...
  const CustomTextInput({
    ...
    this.icon = false,
    this.onChanged,
    this.numericKeyboard = false, // Valor por defecto es falso
  }) : super(key: key);
